				...
				<aside class="hidden w-64 shrink-0 bg-gradient-to-b from-slate-900 to-slate-800 shadow-xl md:block">
					<div class="flex h-full flex-col">
						...
						<div class="flex items-center gap-3 px-6 py-6">
							<div class="flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-0 shadow-lg">
								<img src="{{ asset('logo.png') }}" class="h-10 w-10" alt="Logo">
							</div>
							<div>
								<div class="text-lg font-bold text-white">SMA KP CIWIDEY</div>
